# Real-time multi-object tracking and segmentation using Yolov6 with StrongSORT and OSNet

This is fork from ... to officially implement Yolov6 Support
...
```
git clone --recurse-submodules https://github.com/OshFrosch/Yolov6_StrongSORT_OSNet.git  # clone recursively
